...
public class CommandExecutor {
    ...
    public CommandExecutor(MusicBandCollection collection) {
        this.collection = collection;
    }

    protected Response help() {
        return new Response("Справка:", "Возможные команды: \n" +
                ...
                "'showNumOfParticipants' : вывести значения поля numberOfParticipants всех элементов в порядке возрастания", Mark.STRING);
    }
