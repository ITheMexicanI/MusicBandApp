...
public class CommandValidator {
    ...
    protected Request executeScript(String commandArgs, DatagramChannel channel, SocketAddress serverAddress, User user) { // TODO: не робит но робит
        ...
        if (commandArgs.isEmpty()) {
            System.err.println("Путь должен быть корректным, попробуйте снова");
        ...
        try {
            ...
            RequestSender sender = new RequestSender(new CommandValidator(commandInput), serverAddress, channel, user);
            sender.read();
